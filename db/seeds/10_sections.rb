...
Section.delete_all              
root = Section.create_section(section_piece_hash['root'].id, {:slug=>"root",:global_events=>"page_layout_fixed",:subscribed_global_events=>"page_layout_fixed"}, 
...
container = Section.create_section(section_piece_hash['container'].id, {:slug=>"container",:subscribed_global_events=>"page_layout_fixed"},{'content_layout'=>{86=>bool_true,'86unset'=>unset_false},
'block'=>{15=>"height:100px",'15unset'=>unset_false,101=>"float:left",'101unset'=>unset_false}, 'inner'=>{'15hidden'=>bool_true}})


hmenu = Section.create_section(section_piece_hash['container'].id, {:slug=>"hmenu",:website_id=>website.id},
...
vmenu = Section.create_section(section_piece_hash['container'].id, {:slug=>"vmenu",:website_id=>website.id},
  {'block'=>{'disabled_ha_ids'=>'111'},
   'content_horizontal'=>{'disabled_ha_ids'=>'101'},
   'inner'=>{'15hidden'=>bool_true}})
...
logo = Section.create_section(section_piece_hash['container'].id, {:slug=>"logo",:website_id=>website.id},
  {'block'=>{'disabled_ha_ids'=>'111'},
   'content_horizontal'=>{'disabled_ha_ids'=>'101'},
   'inner'=>{'15hidden'=>bool_true}})
...
text = Section.create_section(section_piece_hash['container'].id, {:slug=>"text",:website_id=>website.id},
  {'block'=>{'disabled_ha_ids'=>'111'},
   'content_horizontal'=>{'disabled_ha_ids'=>'101'},
   'inner'=>{'15hidden'=>bool_true}})
text.add_section_piece(section_piece_hash['text'].id)

blog_post_list = Section.create_section(section_piece_hash['container'].id, {:slug=>"blog_post_list",:website_id=>website.id},
  {'block'=>{'disabled_ha_ids'=>'111'},
   'content_horizontal'=>{'disabled_ha_ids'=>'101'},
   'inner'=>{'15hidden'=>bool_true}})
blog_post_list.add_section_piece(section_piece_hash['blog_post_list'].id).add_section_piece(section_piece_hash['blog_post'].id)

blog_post_detail = Section.create_section(section_piece_hash['container'].id, {:slug=>"blog_post_detail",:website_id=>website.id},
  {'block'=>{'disabled_ha_ids'=>'111'},
   'content_horizontal'=>{'disabled_ha_ids'=>'101'},
   'inner'=>{'15hidden'=>bool_true}})
...
################################################ center area start ##############################################  
center_area = Section.create_section(section_piece_hash['container'].id, {:slug=>"center_area",:subscribed_global_events=>"page_layout_fixed,block_width"},{'content_layout'=>{86=>bool_true,'86unset'=>unset_false},
'block'=>{15=>"height:100px",'15unset'=>unset_false,:disabled_ha_ids=>"101"}})

left_part = Section.create_section(section_piece_hash['container'].id, {:slug=>"left_part",:global_events=>"block_width"},
  {'content_layout'=>{86=>HtmlAttribute::BOOL_TRUE},
   ...
   'inner'=>{'15hidden'=>bool_true}})
right_part = Section.create_section(section_piece_hash['container'].id, {:slug=>"right_part",:global_events=>"block_width"},
  {'content_layout'=>{86=>HtmlAttribute::BOOL_TRUE},
...
center_part = Section.create_section(section_piece_hash['container'].id, {:slug=>"center_part",:global_events=>"block_width"},
  {'content_layout'=>{86=>HtmlAttribute::BOOL_TRUE},
