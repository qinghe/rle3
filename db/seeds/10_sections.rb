...
root = Section.create_section(section_piece_hash['root'].id, {:title=>"root",:global_events=>"page_layout_fixed",:subscribed_global_events=>"page_layout_fixed"}, 
  {'horizontal_content'=>{86=>HtmlAttribute::BOOL_FALSE},
...
container = Section.create_section(section_piece_hash['container'].id, {:title=>"container",:subscribed_global_events=>"page_layout_fixed"},{'horizontal_content'=>{86=>bool_true,'86unset'=>unset_false},
...
################################################ center area start ##############################################  
center_area = Section.create_section(section_piece_hash['container'].id, {:title=>"center_area",:subscribed_global_events=>"page_layout_fixed,block_width"},{'horizontal_content'=>{86=>bool_true,'86unset'=>unset_false},
...
left_part = Section.create_section(section_piece_hash['container'].id, {:title=>"left_part",:global_events=>"block_width"},
  {'horizontal_content'=>{86=>HtmlAttribute::BOOL_TRUE},
